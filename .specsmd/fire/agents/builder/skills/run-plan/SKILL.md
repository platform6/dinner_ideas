...
When work items have dependencies: - They execute **sequentially within the SAME run** - They do **NOT** require separate runs - The dependent item waits for its dependency to complete before starting
